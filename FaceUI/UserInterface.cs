...
// To use FaceUI you first need to create an instance of this class and
...
namespace FaceUI
{
    ...
    {
        /// <summary>Current FaceUI version identifier.</summary>
        ...
        /// <param name="theme">Which UI theme to use (see options in Content/FaceUI/themes/). This affect the appearance of all textures and effects.</param>
