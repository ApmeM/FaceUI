...
// FaceUI needs. If you edit and add new files to content, you probably
...
namespace FaceUI
{
    ...
    public class TexturesGetter<TEnum>
    {
        ...
        /// </summary>
        /// <param name="path">Resource path, under FaceUI content.</param>
    ...
    public static class Resources
    {
        ...
        /// <summary>Root for FaceUI content</summary>
